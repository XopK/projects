...
return [
    ...
    */
    ...
    'video' => 'Поле :attribute должно быть видеофайлом.',
    ...
    */
    ...
    'custom' => [
        'class' => [
            'required' => 'Поле :attribute обязательно.',
            'in' => 'Выбранная категория ":input" недопустима. Выберите категорию из списка.',
        ],
        'selected_week' => [
            'required_if' => 'Заполните расписание, когда активирован флажок.',
        ],
        'levels.*' => [
            'in' => 'Выбрано некорректное значение для сложности. Допустимые значения: С нуля, Начинающий, Средний, Продолжающий.',
        ],
        'photos.*' => [
            ''
        ],
        'video_group' => [
            'max' => 'Размер видео не должен превышать 70 МБ.',
            'min' => 'Размер файла должен быть не меньше :min_mb МБ.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'levels' => 'Сложность',
        'selected_week' => 'Расписание',
        'class' => 'Категория набора',
        'video_group' => 'Видео группы',
