...
<head>
    ...
    <title>419 - Отсутствует токен!</title>
</head>
...
<div class="container mx-auto px-5 my-5">
    <div class="flex flex-col items-center justify-center min-h-screen pb-30">
        <div class="text-6xl font-bold text-indigo-500 animate-pulse">
            419
        </div>
        ...
        <div class="text-center text-lg text-gray-500">
            В запросе отсутствует токен, попробуйте отправить данные заново!
        </div>
